                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row {{ $errors->has('birthday') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control birthday" value="{{ old('birthday') }}" required name="birthday">
                            </div>
                        </div>
                        ...
                        <div class="form-group row {{ $errors->has('document') ? 'is-invalid' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="document" class="form-control document" value="{{ old('document') }}" required name="document">
                            </div>
                        </div>
